...
const AnimatedHeart = ({subclass}:{subclass?:string}) => {
  ...
  return (
    ...
    <input type="checkbox" id="checkbox" readOnly style={{ pointerEvents: 'none' }}  />
    <label htmlFor="checkbox">
      <svg className={subclass} id="heart-svg" viewBox="467 392 58 57" xmlns="http://www.w3.org/2000/svg"  >
