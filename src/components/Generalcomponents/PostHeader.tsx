...
const PostHeader = ({poster,posterId}:{poster:IPoster|undefined,posterId:number|undefined}) => {
  return (
    <Link href={"/profiles/"+posterId} className=" z-10 flex items-center space-x-2 absolute px-4 py-2 sm:px-7 sm:py-3  mt-4 ml-4 sm:mt-12 sm:ml-12 rounded-full !border-borderPrimary glass2 ">
